...
func TestDigest(t *testing.T) {
	in := from_hex("6162636462636465636465666465666765666768666768696768696a68696a6b6" +
		"96a6b6c6a6b6c6d6b6c6d6e6c6d6e6f6d6e6f706e6f7071")
	out256 := from_hex("248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1")
	out512 := from_hex("204a8fc6dda82f0a0ced7beb8e08a41657c16ef468b228a8279be331a703c3359" +
	...
	for _, suite := range supportedSuites {
		...
		if !bytes.Equal(h, out) {
			t.Fatalf("Incorrect digest: %x != %x", h, out)
		}
	}
}
...
func TestEncryptDecrypt(t *testing.T) {
	...
	key128 := from_hex("4c80cdefbb5d10da906ac73c3613a634")
	nonce128 := from_hex("2e443b684956ed7e3b244cfe")
	aad128 := from_hex("000043218765432100000000")
	pt128 := from_hex("45000048699a000080114db7c0a80102c0a801010a9bf15638d3010000010000" +
		"00000000045f736970045f756470037369700963796265726369747902646b00" +
		"0021000101020201")
	ct128 := from_hex("fecf537e729d5b07dc30df528dd22b768d1b98736696a6fd348509fa13ceac34" +
		"cfa2436f14a3f3cf65925bf1f4a13c5d15b21e1884f5ff6247aeabb786b93bce" +
		"61bc17d768fd9732459018148f6cbe722fd04796562dfdb4")

	key256 := from_hex("abbccddef00112233445566778899aababbccddef00112233445566778899aab")
	nonce256 := from_hex("112233440102030405060708")
	aad256 := from_hex("4a2cbfe300000002")
	pt256 := from_hex("4500003069a6400080062690c0a801029389155e0a9e008b2dc57ee000000000" +
		"7002400020bf0000020405b40101040201020201")
	ct256 := from_hex("ff425c9b724599df7a3bcd510194e00d6a78107f1b0b1cbf06efae9d65a5d763" +
